  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: TabBarView(
        ...
        controller: _motionTabBarController,
        children: _screens, // Use the screens list here
      ),
    );
  }
